...
# DATA SAVED:
#\\isdsf00d03\social-care\05-Analysts\Publication\Publication_2122\Client\Outputs\Rounded Data\final

# DATA OUTPUTS PATH
publication_data_path <- "/conf/social-care/05-Analysts/Publication/Publication_2122/Client/Outputs/Rounded Data/final/"


# SAVE OUTPUT PATH
# /conf/social-care/05-Analysts/Publication/Publication_2122/Shiny Apps/client_app/data
...
# TREND ----
duplicates_data_people_supported_trend <- data_people_supported_trend %>% 
  get_dupes() %>% 
...
# CLIENT GROUP ----
duplicates_data_people_supported_client_group <- data_people_supported_client_group %>% 
  get_dupes() %>% 
...
# AGE & SEX ----
duplicates_data_people_supported_age_sex <- data_people_supported_age_sex %>% 
  get_dupes() %>% 
...
# ETHNICITY ----
duplicates_data_people_supported_ethnicity <- data_people_supported_ethnicity %>% 
  get_dupes() %>% 
...
duplicates_data_people_supported_living_alone <- data_people_supported_living_alone %>% 
  get_dupes() %>% 
...
# MEALS ----
duplicates_data_people_supported_meals <- data_people_supported_meals %>% 
  get_dupes() %>% 
...
data_people_supported_age_sex <- data_people_supported_age_sex %>% 
  ...
  mutate(financial_year   = as.character(financial_year),
         ...
         location_order    = recode(sending_location, 
                                           ...
                                           "West Dunbartonshire"            = 32,
                                           "West Lothian"                   = 33),
         age_group        = recode(age_group, '0-17' = "0-17 years",
                                          '18-64' = "18-64 years",
                                          '65-74' = "65-74 years",
                                          '75-84' = "75-84 years",
                                          '85+'   = "85+ years",
         ...
         age_order   = ordered(recode(age_group, 
                                             ...
                                             "85+ years" = 6,
                                             "Unknown" = 7)),
         sex              = recode(sex, "female" = "Female",
                                          "male" = "Male",
                                          "Unknown/N" = "Not Known / Unspecified"),
         sex              = as.character(sex),
         sex_order        = recode(sex, 
                                          "Female" = 1,
                                          "Male" = 2,
...
data_people_supported_ethnicity <- 
  ...
  mutate(financial_year   = as.character(financial_year),
         ...
         age_order   = ordered(recode(age_group, 
                                             ...
                                             "85+ years" = 6,
                                             "Unknown" = 7)),
         ethnicity        = recode(ethnicity, "Not Provided/Not Known" = "Not Provided / Not Known"),
         ethnicity        = as.character(ethnicity),
         ethnicity_order  = recode(ethnicity, 
                                          "White"                               = 1,
                                          "African"                             = 1,
                                          "Asian"                               = 1,
...
data_people_supported_client_group <- data_people_supported_client_group %>% 
  ...
  mutate(financial_year   = as.character(financial_year),
         ...
         age_group        = recode(age_group, '0-17' = "0-17 years",
                                          ...
                                          '85+'   = "85+ years",
                                          'All ages' = "All Ages"),
         age_order        = recode(age_group, "All Ages" = 1,
                                                 "0-17 years"  = 2,
                                                 "18-64 years" = 3,
                                                 "<65 years"   = 4,
                                                 "65-74 years" = 5,
...
data_people_supported_services <- data_people_supported_services %>% 
  mutate(financial_year = as.character(financial_year),
         ...
         location_order    = recode(sending_location, 
                                           ...
                                           "West Dunbartonshire"            = 32,
                                           "West Lothian"                   = 33),
         service_group    = recode(service_group, 
                                          'HC' = "Home Care",
                                          'HS' = "Housing Support",
                                          'CH' = "Care Home",
                                          'SW' = "Social Worker",
...
data_people_supported_living_alone <- 
  ...
  mutate(financial_year   = as.character(financial_year),
         ...
         living_alone_order = recode(living_alone,
                                            "Living Alone" = 1,
                                            "Not Living Alone" = 2,
                                            "Unknown" = 3),
         measure          = recode(measure,
