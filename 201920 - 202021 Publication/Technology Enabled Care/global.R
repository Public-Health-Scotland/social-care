#####################################################
## Technology Enabled Care Global Script ##
#####################################################
...
# desktop file path specification
data_filepath <- "data/"
...
data_completeness_table <- readxl::read_excel(paste0(data_filepath, "data_completeness_table_technology_enabled_care.xlsx"), col_names = TRUE) %>% 
  arrange(`Data Set`, desc(`Financial Year`))


# TREND DATA
# only present all ages
...
palette_agesex_plot <- c('#8856a7','#8856a7')      # PHS palette
