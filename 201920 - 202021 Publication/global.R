####################################
## People Supported Global Script ##
####################################
...
data_completeness_table <- readxl::read_excel(paste0(data_filepath, "data_completeness_table_people_supported.xlsx"), col_names = TRUE) 


## APPENDIX TABLE

appendix_table <- readxl::read_excel(paste0(data_filepath, "partnership_estimated_table_people_supported.xlsx"), col_names = TRUE)
