...
### Script loads data files needed to populate the Home Care shiny app and 
...
data_time_period_end <- "2020/21" # previously called latest_data_year <- "2020/21"
first_quarter <- "2017/18 Q4"
last_quarter <- "2020/21 Q4"
first_census_week <- "2009/10"
last_census_week <- "2020/21" 
...
data_completeness_table <- readxl::read_excel(paste0(data_filepath, "data_completeness_table_home_care.xlsx"), col_names = TRUE) 



##############################################
## Title & Axis Font styles ------
##############################################.
...
# only want to keep png button and icon, remove the rest of the options for  config(modeBarButtonsToRemove = )
...
# individual button colour settings 
