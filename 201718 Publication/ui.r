  ...
  tabsetPanel(
        ...
        navlistPanel(
          ...
          tabPanel(
            ...
            p("The information presented here are compiled from individual level 
              data for all people who received self-directed support during 
              financial year 2017/18. A trend analysis is also shown."),
            p(
              tags$b("Notes:"),
              tags$ul(
                tags$li("People are counted separately for each self-directed 
                        support option they receive so may appear in more than 
                        one option. Therefore, options cannot be added together 
                        to get the total number of people receiving self-directed 
                        support."),
                tags$li("Trend information in this section includes data 
                        previously published by the Scottish Government as part 
                        of the Social Care Survey publication. Data from 2007/08 
                        to 2016/17 has been obtained from",
                ...
                tags$li("Figures for Option 4 have been derived for people who 
                        have received more than one self-directed support option 
                        at any point during the financial year 2017/18.")
                )
              ),
            p(
              tags$b("Data completeness"),
          ...
          tabPanel(
            ...
            p(
              "Fife HSCP was unable to provide self-directed support information 
              for 2017/18. In order to present trend information at Scotland 
              level Fife HSCP has been assumed to have the same number of people 
              choosing direct payments in 2017/18 as were reported in the 2016/17",
              tags$a(href = "https://www.gov.scot/publications/social-care-services-scotland-2017/", 
                     "Social Care Survey.")
            ),
            wellPanel(column(6, shinyWidgets::pickerInput("SDS_location_input",
                                                          "Select Location:",
          ...
          tabPanel(
            ...
            wellPanel(
              column(6, shinyWidgets::pickerInput("SDS_location_input_2",
                                                  "Select Location:",
                                                  choices = unique(data_SDS_options_chosen$sending_location),
                                                  selected = "Scotland"
              )),
              column(6, uiOutput("SDS_age_input_1"))
            ),
            downloadButton(
              outputId = "download_SDS_optionschosen",
              label = "Download data",
              class = "mySDSOptionChosenbutton"
            ),
            tags$head(
              tags$style(".mySDSOptionChosenbutton { 
                         background-color: #0072B2; 
                         } 
                         .mySDSOptionChosenbutton { 
                         color: #FFFFFF; 
                         }")
            ),
            br(),
            mainPanel(
              width = 12,
              plotlyOutput("SDSOptionChosen")
            ),
            br(),
            actionButton("SDS_button_3",
                         "Show/hide table",
                         style = "color: #fff; 
                         background-color:#2171b5; 
                         border-color: #636363"
            ...
            hidden(
              div(
                id = "SDSOptionsChosentable",
                DT::dataTableOutput("table_SDS_optionschosen")
              )
            )
              ),
          ...
          tabPanel(
            ...
            wellPanel(
              column(6, shinyWidgets::pickerInput("SDS_location_input_3",
                                                  "Select Location:",
                                                  choices = unique(data_SDS_client_group$sending_location),
                                                  selected = "Scotland"
              )),
              column(6, uiOutput("SDS_age_input_2"))
            ),
            br(),
            mainPanel(
              width = 12,
          ...
          tabPanel(
            ...
            p("Glasgow City and Fife HSCPs could not provide individual level 
              ...
              To reflect this an 'All Areas Submitted'  total is provided rather 
              than a Scotland total as it would be underestimated."),
            wellPanel(column(6, shinyWidgets::pickerInput("input$SDS_location_input_4",
                                                          "Select Location:",
          ...
          tabPanel(
            ...
            p("Glasgow City and Fife HSCPs could not provide individual level 
              ...
              To reflect this an 'All Areas Submitted' total is provided rather 
              than a Scotland total as it would be underestimated."),
            wellPanel(column(6, shinyWidgets::pickerInput("input$SDS_location_input_5",
                                                          "Select Location:",
      ...
      mainPanel(
        ...
        navlistPanel(
          ...
          tabPanel(
            ...
            wellPanel(column(6, shinyWidgets::pickerInput("HC_location_input_1",
                                                          "Select Location:",
          ...
          tabPanel(
            ...
            wellPanel(
              column(6, shinyWidgets::pickerInput("HC_location_input_2",
                                                  "Select Location:",
                                                  choices = unique(data_homecare_locality$sending_location),
                                                  selected = "All Areas Submitted"
              )),
              column(6, selectInput("HC_measure_input_1",
                                    "Select Measure",
          ...
          tabPanel(
            ...
            p("The category 'Other' within client group includes Drugs, Alcohol, 
              ...
              Autism and Other Vulnerable Groups."),
            wellPanel(
              column(6, shinyWidgets::pickerInput("HC_location_input_3",
                                                  "Select Location:",
                                                  choices = unique(data_homecare_client_group$sending_location),
                                                  selected = "Scotland"
              )),
              column(6, uiOutput("HC_age_input_1"))
            ),
            mainPanel(
              width = 12,
              downloadButton(
          ...
          tabPanel(
            ...
            wellPanel(
              column(6, shinyWidgets::pickerInput("HC_location_input_4",
                                                  "Select Location:",
                                                  choices = unique(data_homecare_service_providers$sending_location),
                                                  selected = "Scotland"
              )),
              column(6, uiOutput("HC_age_input_2"))
            ),
            br(),
            mainPanel(
              width = 12,
          ...
          tabPanel(
            ...
            p("Due to small numbers, and to minimise the risk of identification 
              ...
              'All Areas Submitted' option is selected."),
            wellPanel(
              column(6, shinyWidgets::pickerInput("HC_location_input_5",
                                                  "Select Location:",
                                                  choices = unique(data_homecare_hours_received$sending_location),
                                                  selected = "Scotland"
              )),
              column(6, uiOutput("HC_age_input_3"))
            ),
            mainPanel(
              width = 12,
              downloadButton(
          ...
          tabPanel(
            ...
            p("To reflect these issues an 'All Areas Submitted' total is provided 
              rather than a Scotland figure as it would be underestimated."),
            wellPanel(column(6, shinyWidgets::pickerInput("HC_location_input_6",
                                                          "Select Location:",
          ...
          tabPanel(
            ...
            wellPanel(column(6, shinyWidgets::pickerInput("HC_measure_Input_2",
                                                          "Select Measure:",
          ...
          tabPanel(
            ...
            wellPanel(column(6, shinyWidgets::pickerInput("HC_measure_input_3",
                                                          "Select Measure:",
          ...
          tabPanel(
            ...
            wellPanel(column(6, selectInput("HC_location_input_7",
                                            "Select Location:",
                                            selected = "a",
      ...
      mainPanel(
        ...
        navlistPanel(
          ...
          tabPanel(
            ...
            wellPanel(column(6, shinyWidgets::pickerInput("CH_date_input",
                                                          "Select Date:",
          ...
          tabPanel(
            ...
            wellPanel(
              ...
              column(6, shinyWidgets::pickerInput("CH_location_input",
                                                  "Select Location:",
          ...
          tabPanel(
            ...
            wellPanel(column(6, shinyWidgets::pickerInput("CH_location_input_2",
                                                          "Select Location:",
          ...
          tabPanel(
            ...
            wellPanel(column(6, shinyWidgets::pickerInput("CH_measure_input",
                                                          "Select Measure:",
          ...
          tabPanel(
            ...
            wellPanel(column(6, selectInput("CH_location_input_3",
                                            "Select Location:",
      ...
      mainPanel(
        ...
        navlistPanel(
          ...
          tabPanel(
            ...
            wellPanel(
              column(6, shinyWidgets::pickerInput("CAT_location_input",
                                                  "Select Location:",
                                                  choices = unique(data_alarm_telecare_trend$sending_location),
                                                  selected = "Scotland"
              )),
              column(6, shinyWidgets::pickerInput("CAT_measure_input",
                                                  "Select Measure:",
          ...
          tabPanel(
            ...
            wellPanel(column(6, shinyWidgets::pickerInput("CAT_measure_input_2",
                                                          "Select Measure:",
    ...
    tabPanel(
      ...
      tabPanel(
        ...
        wellPanel(column(6, shinyWidgets::pickerInput("Clients_measure_input",
                                                      "Select measure:",
      ...
      tabPanel(
        ...
        wellPanel(
          column(6, shinyWidgets::pickerInput("Clients_location_input",
                                              "Select Location:",
                                              choices = unique(data_clients_age_sex$sending_location),
                                              selected = "Scotland"
          )),
          column(6, shinyWidgets::pickerInput("Clients_measure_input_2",
                                              "Select Measure:",
      ...
      tabPanel(
        ...
        wellPanel(column(6, shinyWidgets::pickerInput("Clients_location_input_2",
                                                      "Select Location:",
      ...
      tabPanel(
        ...
        wellPanel(
          column(6, shinyWidgets::pickerInput("Clients_location_input_3",
                                              "Select Location:",
                                              choices = unique(data_clients_ethnicity$sending_location),
                                              selected = "Scotland"
          )),
          column(6, shinyWidgets::pickerInput("Clients_measure_input_3",
                                              "Select Measure:",
      ...
      tabPanel(
        ...
        wellPanel(
          column(6, shinyWidgets::pickerInput("Clients_location_input_4",
                                              "Select Location:",
                                              choices = unique(data_clients_client_group$sending_location),
                                              selected = "Scotland"
          )),
          column(6, uiOutput("Clients_age_input")),
          column(6, shinyWidgets::pickerInput("Clients_measure_input_4",
                                              "Select Measure:",
      ...
      tabPanel(
        ...
        p("To reflect data completeness issues an 'All Areas Submitted' 
          total is provided rather than a Scotland total."),
        wellPanel(column(6, shinyWidgets::pickerInput("Clients_location_input_5",
                                                      "Select Location:",
      ...
      tabPanel(
        ...
        wellPanel(column(6, shinyWidgets::pickerInput("Clients_location_input_6",
                                                      "Select Location:",
        ...
        ) #People and Services navlist panel
        ) #People and Services main panel
      ) #End People and Services Summary Tab 
      ) #End Tabeset Panel
  ) #End fluid page
